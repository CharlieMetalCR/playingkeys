...
PlayingKeys is a piano learning platform with a React Native Expo mobile app, NestJS backend API, PostgreSQL database, and an admin dashboard.
...
- Web: Next.js for admin dashboard and showcase, TypeScript strict, Tailwind.
- Backend: NestJS for production APIs.
- Database: PostgreSQL (plyngpDB).
